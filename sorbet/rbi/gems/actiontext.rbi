...
module ActionText::TagHelper
  def rich_text_area_tag(name, value = nil, options = nil, &block); end
  def rich_textarea_tag(name, value = nil, options = nil, &block); end
  def self.id; end
  def self.id=(val); end
end
...
module ActionView::Helpers::FormHelper
  def rich_text_area(object_name, method, options = nil, &block); end
  def rich_textarea(object_name, method, options = nil, &block); end
end
class ActionView::Helpers::FormBuilder
  def rich_text_area(method, options = nil, &block); end
  def rich_textarea(method, options = nil, &block); end
end
