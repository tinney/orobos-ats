...
class Importmap::Map
  ...
  def packages; end
  def pin(name, to: nil, preload: nil, integrity: nil); end
  def pin_all_from(dir, under: nil, to: nil, preload: nil, integrity: nil); end
  def preloaded_module_packages(resolver:, entry_point: nil, cache_key: nil); end
  ...
  def self.pin_line_regexp_for(package); end
